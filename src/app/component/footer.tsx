export default function Footer(){
    return(
        <>
        <footer className="bg-yellow-200 py-6 px-8 font-sans tracking-wide">
      <div className="flex max-lg:flex-col items-center justify-between gap-x-6 gap-y-8">
        ...
        <p className='text-base text-center text-black  max-lg:order-1'>©All rights reserved.</p>
        <ul className="flex justify-center gap-x-6 gap-y-2 flex-wrap">
          <li><a className="text-black  text-base">Terms of Service</a></li>
          <li><a className="text-black  text-base">Privacy Policy</a></li>
          <li><a href="/contact" className="text-black  text-base">Contact</a></li>
        </ul>
      </div>
    </footer>
        </>
